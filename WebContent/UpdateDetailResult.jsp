...
<center><h1>Update Result</h1></center>
</div>
<%
if(session.getAttribute("updateresult").equals("success"))
{
out.print("<br><div align='left'><b>Congratulations!!</b></div>");
out.print("<br><div align='left'><b>Your details has been updated successfully.</b></div>");
}
else if(session.getAttribute("updateresult").equals("error"))
{
	out.print("<br><div align='left'><b>Sorry!!</b></div>");
	out.print("<br><div align='left'><b>Your details cannot be updated.</b></div>");
	out.print("<div align='center' style='colour:red'><font size='3'><b>Please Try Again!!");
}
%>

...
<center><h1>LOAN APPLICATION FAILED</h1></center>
</div>
<%
out.print("<br><div align='left'><h2><b>Sorry!!</b></h2></div>");
out.print("<br><div align='left'><h2><b>Your Loan application has failed at Moneta Bank</b></h2></div>");
out.print("<div align='center' style='colour:red'><font size='3'><h2><b>Please Try Again!!</b></h2>");
%>

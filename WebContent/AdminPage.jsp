...
<center><h1>Administrator's Page</h1></center>
</div>
<marquee style="color: black;font-weight: bolder; font-family: monospace;font-size: 20px"> Hello <%=session.getAttribute("id") %></marquee>
...
<br>
<form action="LogOutServlet" style="float: right;">
<input type="submit" value="Logout">
</form>
<br>
<div class="list">
<ul class="box">
<li><a href="BaseController<%session.setAttribute("Formname","NEW REGISTRATION");%>">New Customer Applications</a></li>

...
<%
out.print("<div align='left'><font size='5'><b>Welcome "+session.getAttribute("custfname")+" "+session.getAttribute("custlname")+"</font></b></div>");
out.print("<br><div align='left'><b>Congratulations!!</b></div>");
out.print("<br><div align='left'><b>You have successfully registered at Moneta Bank</b></div>");
out.print("<br><div align='left'><b>Your Customer ID:"+session.getAttribute("customer_id")+"</b></div>");
out.print("<br><br><br><div align='center' style='colour:red'><font size='3'><b>Please deposit the initial account opening amount and get your documents verified to get your account activated successfully!!<br><br><br><br>");
%>

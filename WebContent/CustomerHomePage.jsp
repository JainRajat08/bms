...
<marquee style="font-weight: bolder;color: black;font-family: monospace;">Hello <%=session.getAttribute("id") %>! Welcome to MONETA Bank</marquee>
<div  style="height:50px; padding:0 0 0 5px;">
<ul class="tab">
<li><a href="contactus.jsp">Contact</a></li>
<li class="right"><a href="HomePage.jsp">Home</a></li>
...
<div class="list" >
<ul class="box">
<li><a href="LoanForm.jsp">Apply Loan</a></li>
<li><a href="TransForm.jsp">Transaction</a>
<li><a href="UpdateCustomerDetails.jsp">Update Profile</a>
<li><a href="BaseController">Generate Bank Statement</a>
</ul>
<%session.setAttribute("Formname","BankStatement"); %>
</div>
</center>

...
<center><h1>Loan Successful</h1></center>
</div>
<%
out.print("<br><div align='left'><b>Congratulations!!</b></div>");
out.print("<br><div align='left'><b>You Loan Application is successfully registered at Moneta Bank</b></div>");
out.print("<br><div align='left'><b>Your Loan-ID is: "+session.getAttribute("loan_id")+"</b></div>");
out.print("<div align='center' style='colour:red'><font size='3'><b><br><br><br>Please wait until the documents get verified and if there are some incomplete documents please submit it to the nearest branch!!<br><br><br>");
%>

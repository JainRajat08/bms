...
<center><h1>REGISTRATION FAILED</h1></center>
</div>
<%
out.print("<div align='left'><font size='5'><b>"+session.getAttribute("custfname")+" "+session.getAttribute("custlname")+"</font></b></div>");
out.print("<br><div align='left'><b>Sorry!!</b></div>");
out.print("<br><div align='left'><b>Your registration have failed at Cognizant Bank</b></div>");
out.print("<div align='center' style='colour:red'><font size='3'><b>Please Try Again!!");
%>
<form action="HomePage.jsp">
<center><br><br><br> <input type="submit" value="Home" class="button"></center> 
</form>
</body>
</html>
...
<div align="center">
<h3>We are sorry to say your account has not been approved. Please Register once again</h3>

<h4>Kindly note that you will not be able to login from this customer Id/user Name. The records will be deleted</h4>
</div>

<form action="BaseController<%session.setAttribute("Formname","RejectedCustomer");%>">

...
<center><h1>TRANSACTION SUCCESSFUL</h1></center>
</div>

<%
out.print("<br><div align='left'><b>Congratulations!!</b></div>");
out.print("<br><div align='left'><b>You transaction is successfully done..</b></div>");
out.print("<br><div align='left'><b>Your Transaction-ID is: "+session.getAttribute("trans_id")+"</b></div>");
%>
